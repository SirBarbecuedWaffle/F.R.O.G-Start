...
func _ready() -> void:
	...
	var specTar=targets.get_children()[randi_range(0,targets.get_children().size()-1)]

	arrow_1.global_position=specTar.global_position
	arrow_1.global_position.y=specTar.global_position.y-170
